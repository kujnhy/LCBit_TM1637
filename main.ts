...
namespace TM1637 {
    ...
    export class TM1637LEDs {
         ...
         */
        //% blockId="TM1637_set_intensity" block="%tm|设置亮度 %val"
         ...
         */
        //% blockId="TM1637_showbit" block="%tm|显示数字 %num |位置 %bit"
        ...
        /**
          ...
          */
        //% blockId="TM1637_showhex" block="%tm|显示16进制 %num"
        //% weight=90 blockGap=8
        //% parts="TM1637"
        showHex(num: number) {
            if (num < 0) {
         ...
         */
        //% blockId="TM1637_showDP" block="%tm|小数点位置 %bit|显示 %show"
         ...
         * clear LED. 
         */
        //% blockId="TM1637_clear" block="清除数字 %tm"
    ...
    //% blockId="TM1637_create" block="4位数码管|CLK %clk|DIO %dio|亮度 %intensity"
    export function create(clk: DigitalPin, dio: DigitalPin, intensity: number): TM1637LEDs {
